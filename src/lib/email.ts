    ...
    html: `
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            <h2>Hello ${name}! 👋</h2>
            <p>Thank you for signing up with Bookify. To complete your registration, please verify your email address using the OTP below:</p>
            ...
            <p>If you didn't create an account with Bookify, please ignore this email.</p>
